    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-4 text-gray-600 leading-relaxed">
          <p>Welcome to RUVA. Please read these terms carefully before using our platform.</p>
          ...
          <p>We accept various payment methods securely. You agree to provide current, complete, and accurate purchase and account information for all purchases made at our store.</p>

          <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">4. Modifications to Service</h2>
